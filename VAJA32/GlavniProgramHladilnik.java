...
/**
 * Razred za prikaz programiranja sezanma objektov
 *
 * @author Primož Vaupotič
 * @version Vaja 33 - Podatki za ustvarjanje vseh objektov in klicanje vseh metod so brani iz ukazne konzole, z zanko, ki sprašuje po lastnostih in vnašala objekte v seznam, dokler uporabnik ne vnese prazne vrstice (pritisnjen Enter brez vnosa).
 */
...
public class GlavniProgramHladilnik {
    ...
    // V seznam dodamo še nekaj anonimnih objektov-hladilnikov
    static {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
			...
			// Vnos podatkov glede kapacitete hladilnika v litrih
