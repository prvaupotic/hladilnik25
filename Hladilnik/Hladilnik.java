...
public class Hladilnik {
     ...
     */
    public void vkljuci() throws Exception{
        if (!vklopljen) {
            vklopljen = true;
			...
			throw new Exception("Hladilnik je že vključen.");
        }
    }
     ...
     */
    public void izkljuci() throws Exception{
        if (vklopljen) {
            vklopljen = false;
			...
			throw new Exception("Hladilnik je že izlključen.");
        }
    }
     ...
     */
    public void povecajTemperaturo(int stopinje) throws Exception{
        if (vklopljen) {
			...
			throw new Exception("Hladilnik mora biti vključen, da lahko spremenite temperaturo.");
        }
    }
     ...
     */
    public void zmanjsajTemperaturo(int stopinje) throws Exception{
        if (vklopljen) {
            temperatura -= stopinje;
            if (temperatura < 0) {
	...
	/**
     * Metoda za izpis vseh hladilnikov.
     * 
     * @return Vrne niz z informacijami o hladilniku.
     */
	 public String toString() {
        return "Hladilnik [model=" + model + ", kapaciteta=" + kapaciteta + " l, vkljucen=" + vklopljen + ", temperatura=" + temperatura + "]";
    }
}