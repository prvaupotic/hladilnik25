 ...
 * @version Vaja 30 - Podatki za ustvarjanje vseh objektov in klicanje vseh metod so brani iz ukazne konzole - razširitev Vaje 28
 */
...
public class GlavniProgramHladilnik {
    ...
    public static void main(String[] args) {
		...
		while (true) {
            ...
            System.out.println("0: Izhod")// Ustvarimo objekt Scanner za branje vhoda;
	...
	private static void izvediDejanje(Hladilnik hladilnik, int dejanje, Scanner scanner) throws Exception {
		...
		switch (dejanje) {
            ...
            case 7:
				...
				break;
            default:
                throw new Exception("Neveljavno dejanje!");
        }
    }
}