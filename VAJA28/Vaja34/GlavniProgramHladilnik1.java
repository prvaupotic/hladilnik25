 ...
 * @version Vaja 34 - Razred hladilnik v Javi - razširitev Vaje 27, dodatna dva podrazreda
 */
public class GlavniProgramHladilnik {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Nastavljena temperatura hladilnika 1: " + hladilnik1.getTemperatura() + " stopinj");
